...
## I changed this - here we can try different prompts
DEBIASING_PREFIXES = {
...
class StereoSetRunner:
    ...
    def __init__(
        ...
        is_self_debias=True,
        bias_type='gender',
        debiasing_prefixes = {"gender": "The following text discriminates against people because of their gender: "},
        bias_position = 13
    ):
        ...
        self.debiasing_prefixes= debiasing_prefixes
    ...
    def _likelihood_score(self):
        ...
        for (
            ...
            if self._is_self_debias:
                ...
                debiasing_prefixes = [self.debiasing_prefixes[self._bias_type]]
                with torch.no_grad():
                    hidden_states = (
            ...
            for sentence in cluster.sentences:
                ...
                if self._is_self_debias:
                    ...
                    probs = torch.softmax(
                        ...
                        logits[1, self.bias_position - 1], dim=-1
                    )
                    ...
                    logits = logits[:, self.bias_position :, :]
