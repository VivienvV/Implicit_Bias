...
parser.add_argument(
    ...
    help="Path to the original data that was evaluated"
)
...
if __name__ == "__main__":
    ...
    if args.predictions_dir is not None:
        ...
        for prediction_file in glob.glob(predictions_dir + "*.json"):
            ...
            parse_file(
                args.data_file, prediction_file
                #f"{args.persistent_dir}/data/stereoset/test.json", prediction_file
            )
    else:
        parse_file(
            args.data_file, args.predictions_file
