"ReplaceGender takes the text from the generated txt files (male, female, unresolved) and replaces all gendered occurences (name, pronouns) "
" with neutral ProtagonistA, etc. Saves the results in .._masked.txt files"
...
predictor = Predictor.from_path(
    "https://storage.googleapis.com/allennlp-public-models/coref-spanbert-large-2020.02.27.tar.gz",cuda_device = -1)
...
jar = 'stanford-ner-4.2.0/stanford-ner-2020-11-17/stanford-ner.jar'
model = 'stanford-ner-4.2.0/stanford-ner-2020-11-17/classifiers/english.conll.4class.distsim.crf.ser.gz'
